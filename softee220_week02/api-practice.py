...
get_ipython().run_line_magic('pip', 'install gdeltdoc')
get_ipython().run_line_magic('pip', 'install newspaper3k')
get_ipython().run_line_magic('pip', 'install lxml[html_clean]')
...
get_ipython().run_line_magic('pip', 'install lxml_html_clean')
